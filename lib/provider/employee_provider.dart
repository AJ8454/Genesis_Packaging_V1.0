import 'dart:convert';
import 'package:genesis_packaging_v1/models/employee.dart';
...
// getter
  ...
  Future<void> fetchAndSetEmployee() async {
    var url =
        'https://genesis-packaging-v-1-default-rtdb.firebaseio.com/employees.json';
    try {
  ...
  Future<void> updateEmployee(String id, Employee newEmployee) async {
    ...
    try {
      if (employeeIndex >= 0) {
        final url =
            'https://genesis-packaging-v-1-default-rtdb.firebaseio.com/employees/$id.json';
